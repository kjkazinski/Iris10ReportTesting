...
namespace IrisWeb
{
    public static class Adocls
    {
        ...
        private static string ConnectionStringLookup(string name)
        {
            ...
            {
                return "Initial Catalog=A_Wallowa9;Data Source=192.168.104.202;User ID=developer;Password=aociris;";
            }
            else
            {
                return "Initial Catalog=IRISSystemData;Data Source=192.168.104.202;User ID=developer;Password=aociris;";
            }
        }
