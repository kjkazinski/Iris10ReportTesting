...
namespace ReportTestApp.Models
{
    ...
    public partial class RISCurb
    {
        public string RISCurb_Key { get; set; }
        public string Road_Key { get; set; }
        public decimal BeginMilepost { get; set; }
        public decimal EndMilepost { get; set; }
        public string RISLookupCurbPlacement_Key { get; set; }
        public string RISLookupCurb_Key { get; set; }
        public Nullable<double> CurbHeight { get; set; }
        ...
        public virtual RISLookupCurbPlacement RISLookupCurbPlacement { get; set; }
