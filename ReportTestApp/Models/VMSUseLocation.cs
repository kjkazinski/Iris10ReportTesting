...
namespace ReportTestApp.Models
{
    ...
    public partial class VMSUseLocation
    {
        public VMSUseLocation()
        {
            this.VMSUseLocationGPS = new HashSet<VMSUseLocationGP>();
        }
        ...
        public virtual ICollection<VMSUseLocationGP> VMSUseLocationGPS { get; set; }
    }
}
