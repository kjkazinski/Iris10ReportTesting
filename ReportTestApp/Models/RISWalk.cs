...
namespace ReportTestApp.Models
{
    ...
    public partial class RISWalk
    {
        public string RISWalk_Key { get; set; }
        public string Road_Key { get; set; }
        public decimal BeginMilepost { get; set; }
        public decimal EndMilepost { get; set; }
        public string RISLookupWalkPlacement_Key { get; set; }
        public Nullable<double> Width { get; set; }
        public string RISLookupWalkMaterial_Key { get; set; }
        ...
        public virtual RISLookupWalkMaterial RISLookupWalkMaterial { get; set; }
        public virtual RISLookupWalkPlacement RISLookupWalkPlacement { get; set; }
