...
namespace ReportTestApp.Models
{
    ...
    public partial class RISJurisdiction
    {
        public string RISJurisdiction_Key { get; set; }
        ...
        public virtual RISLookupCity RISLookupCity { get; set; }
        public virtual RISLookupJurisdiction RISLookupJurisdiction { get; set; }
