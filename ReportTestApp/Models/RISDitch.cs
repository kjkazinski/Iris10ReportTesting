...
namespace ReportTestApp.Models
{
    ...
    public partial class RISDitch
    {
        public string RISDitch_Key { get; set; }
        public string Road_Key { get; set; }
        public decimal BeginMilepost { get; set; }
        public decimal EndMilepost { get; set; }
        public string RISLookupDitchPlacement_Key { get; set; }
        ...
        public virtual RISLookupDitchPlacement RISLookupDitchPlacement { get; set; }
